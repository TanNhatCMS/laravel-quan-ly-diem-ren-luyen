...
use App\Http\Requests\PermissionManager\RoleStoreCrudRequest as StoreRequest;
use App\Http\Requests\PermissionManager\RoleUpdateCrudRequest as UpdateRequest;
...
class RoleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        if (! config('backpack.permissionmanager.allow_role_create')) {
            $this->crud->denyAccess('create');
        }
        if (! config('backpack.permissionmanager.allow_role_update')) {
            $this->crud->denyAccess('update');
        }
        if (! config('backpack.permissionmanager.allow_role_delete')) {
