...
COPY --chown=www-data:www-data --from=node:22.13.1 /usr/local/bin /usr/local/bin

COPY --chown=www-data:www-data --from=node:22.13.1 /usr/local/lib/node_modules/npm /usr/local/lib/node_modules/npm
