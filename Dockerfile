...
COPY --chown=www-data:www-data --from=node:23.9.0 /usr/local/bin /usr/local/bin

COPY --chown=www-data:www-data --from=node:23.9.0 /usr/local/lib/node_modules/npm /usr/local/lib/node_modules/npm
