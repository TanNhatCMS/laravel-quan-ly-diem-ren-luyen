...
COPY --chown=www-data:www-data --from=node:22.15.0 /usr/local/bin /usr/local/bin

COPY --chown=www-data:www-data --from=node:22.15.0 /usr/local/lib/node_modules/npm /usr/local/lib/node_modules/npm
