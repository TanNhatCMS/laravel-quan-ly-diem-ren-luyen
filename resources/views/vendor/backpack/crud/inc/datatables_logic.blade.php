...
{{-- DATA TABLES SCRIPT - Load local assets instead of CDN --}}
...
<script src="{{ asset('vendor/datatables/js/dataTables.fixedHeader.min.js') }}"></script>
<link rel="stylesheet" href="{{ asset('vendor/datatables/css/fixedHeader.dataTables.min.css') }}">
