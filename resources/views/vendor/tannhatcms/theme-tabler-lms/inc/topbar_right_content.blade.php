                    ...
                    <div class="form-selectgroup-boxes row mb-3">
                        <div class="col-lg-4 mb-2">
                            <label class="form-selectgroup-item">
                                <input @if(config('backpack.ui.view_namespace') === 'tannhatcms.theme-coreuiv4-lms::') checked @endif type="radio" name="theme" value="coreuiv4-lms" class="form-selectgroup-input theme-choice">
                                <span class="form-selectgroup-label d-flex align-items-center p-3">
                                        <span class="me-3">
                                            <span class="form-selectgroup-check"></span>
                                        </span>
                                        <span class="form-selectgroup-label-content">
                                            <span class="form-selectgroup-title strong mb-1">Core UI</span><br>
                        ...
                        <div class="col-lg-4 mb-2">
                            <label class="form-selectgroup-item">
                                <input @if(config('backpack.ui.view_namespace') === 'tannhatcms.theme-tabler-lms::') checked @endif type="radio" name="theme" value="tabler-lms" class="form-selectgroup-input theme-choice">
                                <span class="form-selectgroup-label d-flex align-items-center p-3">
                                        <span class="me-3">
                                            <span class="form-selectgroup-check"></span>
                                        </span>
