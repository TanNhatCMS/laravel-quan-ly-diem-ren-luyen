        ...
        <form method="POST" action="{{ route('tabler.switch.layout') }}">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="đóng lại"></button>
                </div>
                    ...
                    <div class="form-selectgroup-boxes row mb-3">
                        <div class="col-lg-4 mb-2">
                            <label class="form-selectgroup-item">
                                <input @if(config('backpack.ui.view_namespace') === 'tannhatcms.theme-coreuiv4lms::') checked @endif type="radio" name="theme" value="coreuiv4lms" class="form-selectgroup-input theme-choice">
                        ...
                        <div class="col-lg-4 mb-2">
                            <label class="form-selectgroup-item">
                                <input @if(config('backpack.ui.view_namespace') === 'tannhatcms.theme-tabler-lms::') checked @endif type="radio" name="theme" value="tabler" class="form-selectgroup-input theme-choice">
                                <span class="form-selectgroup-label d-flex align-items-center p-3">
                                        <span class="me-3">
                                            <span class="form-selectgroup-check"></span>
                                        </span>
